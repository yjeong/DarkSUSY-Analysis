...
void addfiles(TChain *ch, const TString dirname=".")
{
  ...
  if (files) {
	...
	//if (verbose)
	std::cout << "adding fname " << fname <<"to "<<ch<<" dirName "<<dirname<< std::endl;
      }
    }
  }
		...
		if(fabs(genA0_Lz)>bin_edges_Lz[n] && fabs(genA0_Lz)<bin_edges_Lz[n+1]){
		  for(int m=0;m<80;m++){
			...
			for(int j=0;j<npatm;j++){
			  ...
			  if(j==0){ dphi1 = My_dPhi(muJetC_Mu0_phi,genA0_phi); deta1 = muJetC_Mu0_eta - genA0_eta;}
			  if(j==1){ dphi1 = My_dPhi(muJetC_Mu1_phi,genA0_phi); deta1 = muJetC_Mu1_eta - genA0_eta;}
			  if(j==2){ dphi1 = My_dPhi(muJetF_Mu0_phi,genA0_phi); deta1 = muJetF_Mu0_eta - genA0_eta;}
			  if(j==3){ dphi1 = My_dPhi(muJetF_Mu1_phi,genA0_phi); deta1 = muJetF_Mu1_eta - genA0_eta;}
		...
		if(fabs(genA1_Lz)>bin_edges_Lz[n] && fabs(genA1_Lz)<bin_edges_Lz[n+1]){
		  ...
		  for(int m=0;m<80;m++){
			...
			/*  if(j==0){ dphi1 = My_dPhi(selMu0_phi,genA1_phi); deta1 = selMu0_eta - genA1_eta;}
			  ...
			  if(j==0){ dphi1 = My_dPhi(muJetC_Mu0_phi,genA1_phi); deta1 = muJetC_Mu0_eta - genA1_eta;}
			  if(j==1){ dphi1 = My_dPhi(muJetC_Mu1_phi,genA1_phi); deta1 = muJetC_Mu1_eta - genA1_eta;}
			  if(j==2){ dphi1 = My_dPhi(muJetF_Mu0_phi,genA1_phi); deta1 = muJetF_Mu0_eta - genA1_eta;}
			  if(j==3){ dphi1 = My_dPhi(muJetF_Mu1_phi,genA1_phi); deta1 = muJetF_Mu1_eta - genA1_eta;}
...
void makePlots(){
  ...
  TGraphAsymmErrors *gr1 = new TGraphAsymmErrors(num_1D_A0_LXY, den_1D_A0_LXY);
  ...
  TGraphAsymmErrors *gr0 = new TGraphAsymmErrors(num_1D_A1_LXY, den_1D_A1_LXY);
  ...
  TGraphAsymmErrors *gr2 = new TGraphAsymmErrors(num_1D_A0_LZ, den_1D_A0_LZ);
  ...
  TGraphAsymmErrors *gr3 = new TGraphAsymmErrors(num_1D_A1_LZ, den_1D_A1_LZ);
  ...
  TGraphAsymmErrors *gr_eff = new TGraphAsymmErrors(num_1D_A0_pT, den_1D_A0_pT);
  ...
  TGraphAsymmErrors *gr_eff2 = new TGraphAsymmErrors(num_1D_A1_pT, den_1D_A1_pT);
  ...
  TGraphAsymmErrors *gr_a0_le_lxy = new TGraphAsymmErrors(num_LEp9_1D_A0_LXY, den_LEp9_1D_A0_LXY);
  TGraphAsymmErrors *gr_a1_le_lxy = new TGraphAsymmErrors(num_LEp9_1D_A1_LXY, den_LEp9_1D_A1_LXY);
  TGraphAsymmErrors *gr_a1_g_lxy = new TGraphAsymmErrors(num_Gp9_1D_A1_LXY, den_Gp9_1D_A1_LXY);
  TGraphAsymmErrors *gr_a0_g_lxy = new TGraphAsymmErrors(num_Gp9_1D_A0_LXY, den_Gp9_1D_A0_LXY);
  ...
  TGraphAsymmErrors *gr_a0_le_lz = new TGraphAsymmErrors(num_LEp9_1D_A0_LZ, den_LEp9_1D_A0_LZ);
  TGraphAsymmErrors *gr_a1_le_lz = new TGraphAsymmErrors(num_LEp9_1D_A1_LZ, den_LEp9_1D_A1_LZ);
  TGraphAsymmErrors *gr_a1_g_lz = new TGraphAsymmErrors(num_Gp9_1D_A1_LZ, den_Gp9_1D_A1_LZ);
  TGraphAsymmErrors *gr_a0_g_lz = new TGraphAsymmErrors(num_Gp9_1D_A0_LZ, den_Gp9_1D_A0_LZ);
  ...
  TGraphAsymmErrors *gr_a0_le_lxy_trig = new TGraphAsymmErrors(num_Trig_LEp9_1D_A0_LXY, den_Trig_LEp9_1D_A0_LXY);
  TGraphAsymmErrors *gr_a1_le_lxy_trig = new TGraphAsymmErrors(num_Trig_LEp9_1D_A1_LXY, den_Trig_LEp9_1D_A1_LXY);
  TGraphAsymmErrors *gr_a1_g_lxy_trig = new TGraphAsymmErrors(num_Trig_Gp9_1D_A1_LXY, den_Trig_Gp9_1D_A1_LXY);
  TGraphAsymmErrors *gr_a0_g_lxy_trig = new TGraphAsymmErrors(num_Trig_Gp9_1D_A0_LXY, den_Trig_Gp9_1D_A0_LXY);
  ...
  TGraphAsymmErrors *gr_a0_le_lz_trig = new TGraphAsymmErrors(num_Trig_LEp9_1D_A0_LZ, den_Trig_LEp9_1D_A0_LZ);
  TGraphAsymmErrors *gr_a1_le_lz_trig = new TGraphAsymmErrors(num_Trig_LEp9_1D_A1_LZ, den_Trig_LEp9_1D_A1_LZ);
  TGraphAsymmErrors *gr_a1_g_lz_trig = new TGraphAsymmErrors(num_Trig_Gp9_1D_A1_LZ, den_Trig_Gp9_1D_A1_LZ);
  TGraphAsymmErrors *gr_a0_g_lz_trig = new TGraphAsymmErrors(num_Trig_Gp9_1D_A0_LZ, den_Trig_Gp9_1D_A0_LZ);
